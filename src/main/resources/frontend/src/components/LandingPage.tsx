import { NavDropDownButton, Menu, GridContainer, SocialLink, FooterNav, Grid, Logo, SocialLinks, Address, GovBanner, Header, Title, NavMenuButton, ExtendedNav, Search, MediaBlockBody, Footer } from "@trussworks/react-uswds";
import React, { useState } from "react";


// Landing page template taken from the Trussworks Storybook:  https://trussworks.github.io/react-uswds/?path=/docs/page-templates-landing-page--docs
...
export function LandingPage(): React.ReactElement {
  ...
  const footerSecondary = <>
      <Grid row gap>
        <Logo size="medium" image={<img className="usa-footer__logo-img" src={""} alt="img" />} heading={<p className="usa-footer__logo-heading">Name of Agency</p>} />
          ...
          <GridContainer>
            <Grid row gap className="usa-graphic-list__row">
              ...
              col: true
                ...
                <img className="usa-media-block__img" src={""} alt="Alt text" />
                <MediaBlockBody>
